...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const opp4 = await prisma.opportunity.create({ data: { title: "Orthopedic Surgical Services Expansion", hospitalId: h3.id, assignedRepId: rep3?.id, stage: "DEMO", serviceLine: "ORTHOPEDICS", value: 220000, closeDate: new Date("2026-05-15"), priority: "MEDIUM" } });
